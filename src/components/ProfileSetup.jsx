...
// name. We generate their Flow ID for them and retry a couple of times in
...
export default function ProfileSetup({ userId, onDone }) {
  ...
  async function handleSubmit(e) {
    ...
    for (let attempt = 0; attempt < 5; attempt++) {
      ...
      lastError = error
      // 23505 = unique_violation. Only worth retrying if it was the flow_id
